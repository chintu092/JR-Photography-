...
export default function Navbar({ currentPage, onNavigate, theme }: NavbarProps) {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl xl:max-w-[1440px] 2xl:max-w-[1600px] 3xl:max-w-[1760px] mx-auto px-6 md:px-12 flex justify-between items-center">
          {/* Brand Logo */}
          <motion.div
          ...
          <nav className="hidden lg:flex items-center space-x-1.5 bg-black/30 p-1.5 rounded-full border border-white/5 backdrop-blur-sm">
            {NAV_ITEMS.map((item, idx) => {
              ...
              const isWorkActive = item.id === "works" && currentPage.startsWith("works");
              const isBlogActive = item.id === "blog" && currentPage.startsWith("blog");
              const isActive = currentPage === item.id || isWorkActive || isBlogActive;
          ...
          >
            ...
            <a
                ...
                onMouseEnter={handleHover}
                className="group flex items-center space-x-2 text-[11px] font-display font-bold uppercase py-2.5 px-5 bg-white text-black hover:bg-[#B7BE43] hover:text-black rounded-full transition-all duration-300 shadow-lg hover:shadow-luxury-gold/10"
                id="nav-cta-btn"
            >
          ...
          <button
            ...
            onMouseEnter={handleHover}
            className="lg:hidden p-2 text-luxury-cream hover:text-[#B7BE43] transition-colors cursor-pointer"
        ...
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col space-y-6">
              <span className="text-[10px] font-mono tracking-widest text-luxury-gray border-b border-white/5 pb-2 uppercase">
                Browse Directory
              </span>
                  ...
                  return (
                    <motion.a
                      ...
                      className={`text-xl font-display font-semibold tracking-wider uppercase transition-colors flex items-center justify-between ${
                        isActive ? "text-[#B7BE43]" : "text-luxury-cream hover:text-[#B7BE43]"
                      }`}
                    ...
                    >
                      ...
                      {isActive && <span className="w-1.5 h-1.5 bg-[#B7BE43] rounded-full" />}
                    </motion.a>
                  );
                })}
              </nav>
            ...
            <div className="flex flex-col space-y-6 pt-6 border-t border-white/5">
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="p-2.5 rounded-full bg-white/5 text-luxury-cream hover:bg-[#B7BE43]/15 hover:text-[#B7BE43] transition-colors"
                >
